...
describe("/photos", () => {
  ...
  it("when click delete on an item, should fetch the correct url", async () => {
    ...
    expect(fetch).lastCalledWith(
      "https://gallery-app-server.vercel.app/photos/10",
      {
        method: "DELETE",
      }
    );
...
describe("/add", () => {
  it("when submit should call fetch with correct url", async () => {
    ...
    expect(lastCall[0]).toBe("https://gallery-app-server.vercel.app/photos");
...
describe("/photos/:id", () => {
  it("should render with correct fetch url", async () => {
    ...
    expect(fetch).lastCalledWith(
      "https://gallery-app-server.vercel.app/photos/5"
    );
    ...
    const lastCall = fetch.mock.lastCall;
    expect(lastCall[0]).toBe("https://gallery-app-server.vercel.app/photos/5");
